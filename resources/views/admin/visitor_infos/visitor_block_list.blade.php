...
@section('title')Visitor Block List @endsection
@section('content')
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div> Visitor Block List</div>
        </div>
        @can('Visitor-block-remove')
        <div class="page-title-actions">
            <div class="d-inline-block dropdown">
                <a href="#" onclick="if(confirm('Are You sure to remove !')){
            ...
            <div class="card-body">
                <form action="{{route('admin.visitorIpBlock')}}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="">Enter Ip Address to block</label>
