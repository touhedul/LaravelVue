                            ...
                            <div class="widget-content-outer">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left">
                                        <div class="widget-heading">Today's User Registered</div>
                                    </div>
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-success">{{$todayUser ?? ''}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3 widget-content">
                            <div class="widget-content-outer">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-success">{{$todayOrder ?? '5'}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card mb-3 widget-content">
                            <div class="widget-content-outer">
                                <div class="widget-content-wrapper">
                                    <div class="widget-content-left">
                                        <div class="widget-heading">Today's Transaction</div>
                                    </div>
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-success">{{$todayOrder ?? '1505'}}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card mb-3 widget-content bg-grow-early">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    <div class="widget-heading">This Week User Registered</div>
                                </div>
                                <div class="widget-content-right">
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                ...
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-white"><span> {{$monthUser ?? ''}}</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                ...
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-white"><span> {{$monthOrder ?? '41'}}</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4">
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                ...
                                <div class="widget-content-right">
                                    <div class="widget-numbers text-white"><span> {{$monthOrder ?? '4111'}}</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header"><span class="text-primary">Recently registered users</span></div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ \Carbon\Carbon::parse($recentlyRegisteredUser->created_at)->diffForHumans() }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
