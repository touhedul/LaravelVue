...
@section('title')Translate Language @endsection
@section('content')
@include('includes.page_header',['title'=>'Translate Language','url'=>route('admin.languages.index'),'icon' => $icon,'permission'=>'Language-view'])
<div class="row">
    <div class="col-md-12">
