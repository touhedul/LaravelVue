...
class VisitorInfoController extends Controller
{
    ...
    public function visitorInfoDeleteAll()
    {
        ...
        notify()->success("Deleted Successful.", "Success");
        return back();
    }
    ...
    public function visitorRemoveFromBlockList($id)
    {
        ...
        notify()->success("Removed from block list.", "Success");
        return back();
    }
    ...
    public function visitorRemoveFromBlockListAll()
    {
        ...
        notify()->success("All Ip removed from block list.", "Success");
        return back();
    }
    ...
    public function visitorIpBlock(Request $request)
    {
        ...
        notify()->success("Ip added to block list.", "Success");
        return back();
    }
}
